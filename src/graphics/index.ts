...
function startWindow(webgl: any) {
  let { r, g, b } = {
    r: 150,
    g: 20,
    b: 130,
 ...
 * and sets the color.
 */
function initWebGL(webgl: any, vortexes: any) {
 ...
 * 2_vertex_shader.js.
 */
function createVertexShader(webgl: any, vertexCode: any) {
 ...
 * 2_vertex_shader.js.
 */
function createFragmentShader(webgl: any, fragmentCode: any) {
 ...
 * to buffer objects.
 */
function transformCoordinatesAndSet(webgl: any, shaderProgram: any) {
